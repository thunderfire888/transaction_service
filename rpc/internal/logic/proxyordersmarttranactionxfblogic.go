...
type ProxyOrderSmartTranactionXFBLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewProxyOrderSmartTranactionXFBLogic(ctx context.Context, svcCtx *svc.ServiceContext) *ProxyOrderSmartTranactionXFBLogic {
	return &ProxyOrderSmartTranactionXFBLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *ProxyOrderSmartTranactionXFBLogic) ProxyOrderSmartTranaction_XFB(in *transactionclient.ProxyOrderSmartRequest) (resp *transactionclient.ProxyOrderResponse, err error) {
	tx := l.svcCtx.MyDB
	req := in.Req
	rate := in.Rate
